export default async (req) => {
  ...
  try{
    ...
    const priceMap = { proto: process.env.STRIPE_PRICE_PROTO, resina: process.env.STRIPE_PRICE_RESINA, express: process.env.STRIPE_PRICE_EXPRESS };
    ...
    const params = new URLSearchParams(); params.set("mode","payment"); params.set("success_url", origin + "/?checkout=success"); params.set("cancel_url", origin + "/?checkout=cancel");
